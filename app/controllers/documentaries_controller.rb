class DocumentariesController < ApplicationController
  ...
  def create
    ...
    if @documentary.save
      redirect_to documentaries_url, notice: 'El documental ha sido creado exitosamente.'
    else
      render :new
    end
  end
  ...
  def update
    if @documentary.update(documentary_params)
      redirect_to documentaries_url, notice: 'El documental ha sido actualizado exitosamente.'
    else
      render :edit
    end
  end
